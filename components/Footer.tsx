    ...
    <footer className="bg-dark-accent text-white py-20">
      <div className="container mx-auto px-6 md:px-20 lg:px-32">
        ...
        <div className="grid md:grid-cols-4 gap-12 pt-16 border-t border-white/10">
          <div className="col-span-1 md:col-span-2">
            <span className="text-2xl font-serif font-bold tracking-tight mb-6 block">
              Vitória <span className="text-primary">Dafne</span>
            </span>
            <p className="text-white/60 max-w-sm mb-8 leading-relaxed">
              Nutrição especializada em emagrecimento, reeducação alimentar e hipertrofia. Sua jornada para uma saúde plena começa aqui.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/60">
              ...
              <li><Link href="#jornada" className="hover:text-primary transition-colors">Especialidades</Link></li>
              <li><Link href="#metodologia" className="hover:text-primary transition-colors">Método</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/60">
              <li>contato@vitoriadafne.com.br</li>
              <li>(11) 98187-8996</li>
        ...
        <div className="mt-20 pt-8 border-t border-white/5 text-center text-sm text-white/30">
          <p>© 2026 Vitória Dafne Nutricionista. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
